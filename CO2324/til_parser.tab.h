...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    tTYPE_DOUBLE = 263,            /* tTYPE_DOUBLE  */
    tTYPE_STRING = 264,            /* tTYPE_STRING  */
    tTYPE_VOID = 265,              /* tTYPE_VOID  */
    tEXTERNAL = 266,               /* tEXTERNAL  */
    tFORWARD = 267,                /* tFORWARD  */
    tPUBLIC = 268,                 /* tPUBLIC  */
    ...
    tSET = 279,                    /* tSET  */
    tINDEX = 280,                  /* tINDEX  */
    tOBJECTS = 281,                /* tOBJECTS  */
    tSIZEOF = 282,                 /* tSIZEOF  */
    tFUNCTION = 283,               /* tFUNCTION  */
    tPROGRAM = 284,                /* tPROGRAM  */
    tPRINT = 285,                  /* tPRINT  */
    tPRINTLN = 286,                /* tPRINTLN  */
    tAND = 287,                    /* tAND  */
    tOR = 288,                     /* tOR  */
    tGE = 289,                     /* tGE  */
    tLE = 290,                     /* tLE  */
